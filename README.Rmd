...
ss_path <- "/Applications/SaTScan.app/Contents/MacOS/SaTScan" # Depend on yours location
...
```{r eval=FALSE}
# Level 1: Data defaults
# Derived from ss_tbl specifications
cas <- ss_cas(..., time_precision = "day")
# → Sets PrecisionCaseTimes = 0

# Level 2: Function overrides
result <- satscanr(cas, geo, pop,
                   MonteCarloReps = 9999,
                   MaxSpatialSizeInPopulation = 25)

# Level 3: Template files
result <- satscanr(cas, geo, pop,
                   prm_path = "space_time_template.prm")
```
